                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Container(
                            ...
                            child:
                            Text('We Care', style:
                            TextStyle(fontSize: 25,fontWeight: FontWeight.w600,color: Colors.white,letterSpacing: 1.2),
                            )
                        ),
                      ],
                    ),
                    ...
                    Container(
                        ...
                        child:
                        Text(email, style:
                        TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white,letterSpacing: 1.2),
                        )
                    ),
                    SizedBox(
                      height: 55,
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            child: ClipRRect(
                              ...
                              child: image != null?Image.file(image,fit: BoxFit.fill,):Image.asset('assets/user.png',fit: BoxFit.fill),
                            )
                          ),
                        )
                    ),
                    Container(
                      ...
                      TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: Colors.black,letterSpacing: 1.2),
                      ),
                    ),
                    Row(
                      children: [
                        ...
                        TextStyle(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.black,letterSpacing: 1.2),
                        ),
                      ],
                    ),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            height: 50,
                            width: 50,
                            child: Icon(Icons.create,size: 28,color: Colors.white,),
                            decoration: BoxDecoration(
